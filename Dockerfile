...
RUN     apt-get -y install python-django-tagging python-simplejson python-memcache python-ldap python-cairo python-pysqlite2 python-support \
                           python-pip gunicorn supervisor nginx-full nodejs git wget curl openjdk-7-jre build-essential python-dev --no-install-recommends
...
RUN     mkdir /src/grafana                                                                                    &&\
        mkdir /opt/grafana                                                                                    &&\
        wget https://grafanarel.s3.amazonaws.com/builds/grafana-4.2.0-1485181773pre1.linux-x64.tar.gz -O /src/grafana.tar.gz &&\
